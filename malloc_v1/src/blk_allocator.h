...
/**
 * @brief Structure representing metadata for a memory block in a block allocator.
 */
struct blk_meta
{
...
/**
 * @brief Allocates a block of memory of a specified size from the block allocator.
 *
 * @param blka Pointer to the block allocator from which to allocate.
 * @param size The size of the memory block to allocate, in bytes.
 * @return A pointer to the allocated blk_meta structure, or NULL if the allocation fails.
 */
 ...
 *
 * @param blk Pointer to the blk_meta structure representing the block to be freed.
 */
 ...
 *
 * @param blka Pointer to the block allocator from which the block is to be removed.
 * @param blk Pointer to the blk_meta structure representing the block to be removed.
 */
